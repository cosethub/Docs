...
| [Credentials](./credentials) | Create, update, delete, and test Credential Hub entries |
...
| Priority | Endpoints |
| --- | --- |
| **P0 — read** | Auth, warehouses list, tables/schema, query rows, file-store list/download, job run status |
