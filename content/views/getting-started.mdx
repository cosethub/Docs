...
<Callout type="info">
  **Screenshot placeholder** (`views-tab.png`)

  Placeholder: Warehouse Databases page with the Views tab selected and the views list visible.
</Callout>
...
<Callout type="info">
  **Screenshot placeholder** (`create-view.png`)

  Placeholder: Create View control and the empty create-view sidebar.
</Callout>
...
<Callout type="info">
  **Screenshot placeholder** (`schema-and-name.png`)

  Placeholder: Schema and Name fields at the top of the view form.
</Callout>
...
<Callout type="info">
  **Screenshot placeholder** (`base-table.png`)

  Placeholder: Table field with the picker open.
</Callout>
...
<Callout type="info">
  **Screenshot placeholder** (`row-mode.png`)

  Placeholder: The two “I want to” radio options.
</Callout>
...
<Callout type="info">
  **Screenshot placeholder** (`select-columns.png`)

  Placeholder: Select columns list with at least one column configured.
</Callout>
...
<Callout type="info">
  **Screenshot placeholder** (`save-view.png`)

  Placeholder: Save button on the create sidebar, or the new view in the list after save.
</Callout>
