...
<Callout type="info">
  **Screenshot placeholder** (`ai-entry.png`)
  ...
  Placeholder: Create View using AI button on the Views tab.
</Callout>
...
<Callout type="info">
  **Screenshot placeholder** (`ai-chat-list.png`)

  Placeholder: Chat list pane and “Select a chat to start” empty state.
</Callout>
...
<Callout type="info">
  **Screenshot placeholder** (`ai-conversation.png`)

  Placeholder: Conversation with a user prompt and assistant reply.
</Callout>
...
<Callout type="info">
  **Screenshot placeholder** (`ai-draft-form.png`)

  Placeholder: Draft view form populated from the chat, ready to edit.
</Callout>
...
<Callout type="info">
  **Screenshot placeholder** (`ai-save.png`)

  Placeholder: Save control on the AI view draft.
</Callout>
