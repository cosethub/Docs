...
<Callout type="info">
  **Screenshot placeholder** (`workflow-tree.png`)

  Placeholder: View Workflow tree with a Group and a few child jobs.
</Callout>
...
<Callout type="info">
  **Screenshot placeholder** (`workflow-choose-type.png`)

  Placeholder: Step 1 job type picker with categories.
</Callout>
...
<Callout type="info">
  **Screenshot placeholder** (`workflow-name-schedule.png`)

  Placeholder: Step 2 with parent-status vs independent schedule.
</Callout>
...
<Callout type="info">
  **Screenshot placeholder** (`workflow-configure-fields.png`)

  Placeholder: Step 3 type-specific fields.
</Callout>
...
<Callout type="info">
  **Screenshot placeholder** (`workflow-run-conditions.png`)

  Placeholder: Tree showing On success and On failure children under one parent.
</Callout>
